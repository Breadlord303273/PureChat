...
//FACTIONS DEPEND
use _64FF00\PureChat\factions\{FactionsInterface, FactionsProNew, FactionsProOld, PiggyFactions, XeviousPE_Factions};
...
class PureChat extends PluginBase {
    ...
    */
    ...
    public function onCommand(CommandSender $sender, Command $cmd, string $label, array $args) : bool {
        ...
        switch(strtolower($cmd->getName())) {
            case "setformat":
                ...
                if (count($args) < 3) {
                    $sender->sendMessage(self::MAIN_PREFIX . TextFormat::GRAY . " Usage: /setformat <group> <world> <format>");
                ...
                if ($group === null) {
                    $sender->sendMessage(self::MAIN_PREFIX . TextFormat::RED . " Group " . $args[0] . "does NOT exist.");
                ...
                if ($args[1] !== "null" and $args[1] !== "global") {
                    ...
                    if ($level === null) {
                        $sender->sendMessage(self::MAIN_PREFIX . TextFormat::RED . " Invalid World Name!");
                ...
                $sender->sendMessage(self::MAIN_PREFIX . " You set the chat format of the group to " . $chatFormat . ".");
            ...
            case "setnametag":
                ...
                if (count($args) < 3) {
                    $sender->sendMessage(self::MAIN_PREFIX . TextFormat::GRAY . " Usage: /setnametag <group> <world> <format>");
                ...
                $sender->sendMessage(self::MAIN_PREFIX . " You set the nametag of the group to " . $nameTag . ".");
            ...
            case "setprefix":
                ...
                if (!$sender instanceof Player) {
                    $sender->sendMessage(self::MAIN_PREFIX . TextFormat::RED . " This command can be only used in-game!");

                    return true;
                }

                if (!isset($args[0])) {
                    $sender->sendMessage(self::MAIN_PREFIX . TextFormat::GRAY . " Usage: /setprefix <prefix>");
                ...
                $sender->sendMessage(self::MAIN_PREFIX . " You set your prefix to " . $prefix . ".");
            ...
            case "setsuffix":
                ...
                if(!isset($args[0])) {
                    $sender->sendMessage(self::MAIN_PREFIX . TextFormat::GRAY . " Usage: /setsuffix <suffix>");
                ...
                $sender->sendMessage(self::MAIN_PREFIX . " You set your suffix to " . $suffix . ".");
    ...
    private function fixOldConfig() {
        ...
        $this->getLogger()->notice(TextFormat:: GREEN . "Upgraded" . self::MAIN_PREFIX . "config.yml to the latest version");
    }
    ...
    private function loadFactionsPlugin() {
        ...
        if ($factionsPluginName === null) {
            $this->getLogger()->notice(TextFormat::RED . "No valid Factions plugin in default-factions-plugin node was found. Disabling Factions plugin support.");
            ...
            switch (strtolower($factionsPluginName)) {
                case "factionspro":
                    ...
                    if ($factionsPro !== null) {
                        ...
                        if (version_compare($factionsPro->getDescription()->getVersion(), "1.4.0") === -1) {
                            ...
                            $this->getLogger()->notice(TextFormat::GREEN . "FactionsPro < 1.4 support enabled.");
                ...
                case "xeviouspe-factions":
                    ...
                    if($this->getServer()->getPluginManager()->getPlugin("XeviousPE-Factions") !== null)
                    {
                        ...
                        $this->getLogger()->notice(TextFormat::GREEN . "XeviousPE-Factions support enabled.");
                ...
                case "piggyfactions":
                    ...
                    if($this->getServer()->getPluginManager()->getPlugin("PiggyFactions") !== null)
                    {
                        ...
                        $this->getLogger()->notice(TextFormat::GREEN . "PiggyFactions support enabled.");

                        break;
                    }

                    $this->getLogger()->notice(TextFormat::RED . "PiggyFactions was not found. Disabling Factions plugin support.");
    ...
    public function getOriginalChatFormat(Player $player, $levelName = null) {
        ...
        if ($levelName === null) {
            ...
            if ($this->config->getNested("groups." . $group->getName() . ".chat") === null) {
                $this->getLogger()->critical(TextFormat::RED . "Invalid chat format found in config.yml (Group: " . $group->getName() . ") / Setting it to default value.");
            ...
            if ($this->config->getNested("groups." . $group->getName() . "worlds.$levelName.chat") === null) {
                $this->getLogger()->critical(TextFormat::RED . "Invalid chat format found in config.yml (Group: " . $group->getName() . ", WorldName = $levelName) / Setting it to default value.");
    ...
    public function getOriginalNametag(Player $player, $levelName = null) {
        ...
        if ($levelName === null) {
            ...
            if ($this->config->getNested("groups." . $group->getName() . ".nametag") === null) {
                $this->getLogger()->critical(TextFormat::RED . "Invalid nametag found in config.yml (Group: " . $group->getName() . ") / Setting it to default value.");
            ...
            if ($this->config->getNested("groups." . $group->getName() . "worlds.$levelName.nametag") === null) {
                $this->getLogger()->critical(TextFormat::RED . "Invalid nametag found in config.yml (Group: " . $group->getName() . ", WorldName = $levelName) / Setting it to default value.");
